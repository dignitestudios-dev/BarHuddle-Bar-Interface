    ...
    const termsSections = [
        {
            ...
            content:
                "By creating a BarHuddle account or using our Owner Portal, you agree to these Terms and Conditions. If you do not agree, please do not use the platform. These terms apply to all users, including venue owners, event organizers, and promotional partners.",
        },
        {
            title: "Account Responsibilities",
            content:
                "You are responsible for maintaining the confidentiality of your login credentials and for all activities under your account. You must provide accurate, complete information and keep it updated. BarHuddle reserves the right to suspend accounts found in violation of these terms.",
        },
        {
            title: "Venue Ownership Claims",
            content:
                "When claiming a venue on BarHuddle, you confirm that you have legal authority to represent and manage the claimed venue. False claims are a violation of these terms and may result in permanent account termination and legal action.",
        },
        {
        ...
        },
        {
            ...
            content:
                "Subscription payments are processed securely via our payment partner. All charges are in USD. Subscriptions auto-renew unless cancelled prior to the renewal date. Refunds are considered on a case-by-case basis as outlined in our Refund Policy.",
        },
        {
            title: "Termination",
            content:
                "BarHuddle may terminate or suspend your account at any time for violations of these terms, fraudulent activity, or at our discretion with reasonable notice. You may terminate your account at any time through the Delete Account feature in Settings.",
        },
    ];
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="font-normal text-[12px] leading-[16px] text-[#8B7EC8]">
                        The rules and agreements that govern your use of BarHuddle.
                    </p>
                </div>
            </div>
