    ...
    return (
        ...
        >
            ...
            <div className="relative w-full h-[210px] flex items-center justify-center z-10">
                ...
                {/* Outer Floating Percentage Badges */}
                <span className="absolute top-2 right-8 text-[11px] font-bold text-[#4ADE80]">
                    37%
                </span>
                <span className="absolute bottom-6 left-2 text-[11px] font-bold text-[#7C3AED]">
                    49%
                </span>
                <span className="absolute bottom-12 right-2 text-[11px] font-bold text-[#F87171]">
                    14%
                </span>
            </div>
