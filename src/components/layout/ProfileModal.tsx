...
export function ProfileModal({
    ...
    return (
        <div className="fixed inset-0 z-[90] bg-black/60 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-200 font-['Manrope',sans-serif]">
            {/* Backdrop Click */}
            <div className="absolute inset-0" onClick={onClose} />

            {/* Modal Dialog Card */}
            <div className="relative w-[591px] h-[666px] max-w-[95vw] max-h-[95vh] bg-[rgba(14,9,60,0.76)] border border-[rgba(124,58,237,0.2)] shadow-[0px_8px_40px_rgba(0,0,0,0.5),inset_0px_1px_0px_rgba(255,255,255,0.06)] rounded-[28px] overflow-hidden select-none z-10">
                {/* Close Button */}
                <button
                    type="button"
                    onClick={onClose}
                    className="absolute top-[20px] right-[20px] z-30 w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 text-white flex items-center justify-center transition-colors cursor-pointer border border-white/10"
