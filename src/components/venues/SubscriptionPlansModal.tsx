...
export function SubscriptionPlansModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 sm:p-6 animate-in fade-in duration-200 overflow-y-auto font-['Manrope',sans-serif]">
            ...
            <div className="relative w-full max-w-[1000px] my-auto bg-[#05033A] border border-[rgba(124,58,237,0.3)] shadow-[0px_8px_32px_rgba(0,0,0,0.5)] rounded-[24px] p-6 sm:p-10 flex flex-col items-center gap-8 max-h-[95vh] overflow-y-auto scrollbar-none">
                {/* Close Button */}
                <button
                    type="button"
                    onClick={onClose}
                ...
                <button
                    ...
                    className="w-[180px] h-[57px] px-[30px] py-3 rounded-[24px] bg-gradient-to-br from-[#7C3AED] to-[#9F4FFA] shadow-[0px_0px_24px_rgba(124,58,237,0.5),0px_0px_48px_rgba(232,255,87,0.1)] flex items-center justify-center font-extrabold text-[16px] leading-[45px] text-white hover:brightness-110 active:scale-95 transition-all cursor-pointer shrink-0"
                >
                    Next
                </button>
            </div>
